...
import { CASSETTE_SPECS, CD_SPECS, orderUrl, request, shippingOptionsUrl, statusUrl } from "../lib/kunaki.mjs";
...
let result;
if (command === "specs") result = { cassette: CASSETTE_SPECS, cd: CD_SPECS };
