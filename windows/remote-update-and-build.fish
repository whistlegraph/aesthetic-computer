...
set local_zip /workspaces/aesthetic-computer/system/public/assets/false.work/spiderlily-windows-$build_version.zip
set local_log /workspaces/aesthetic-computer/system/public/assets/false.work/spiderlily-windows-$build_version.txt
set s3_endpoint "https://sfo3.digitaloceanspaces.com"
set s3_bucket "s3://assets-aesthetic-computer/false.work"

aws s3 cp $local_zip $s3_bucket/spiderlily-windows-$build_version.zip --endpoint-url $s3_endpoint --acl public-read
aws s3 cp $local_log $s3_bucket/spiderlily-windows-$build_version.txt --endpoint-url $s3_endpoint --acl public-read
