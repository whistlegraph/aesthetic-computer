...
poorslice & macOS (M1) & viewer; kidlispkids hourly art loop \\
jastow & \chip{acblue}{Fedora} & RTX 3070 BTX miner \\
...
\midrule
system & Node 24 & lith (Express+Caddy) \\
session-server & Node 24 & DO droplet (systemd) \\
lith & Node ESM (express 5) & the monolith itself \\
oven & Node 24 (express 4) & oven droplet \\
...
mcp-server & Node 24 & npm @aesthetic.computer/mcp \\
