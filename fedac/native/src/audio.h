...
// Voice layout, wave/gun enums, and core voice-pool constants live in
// synth_types.h so the macOS SDL3 driver can share them without pulling
// in pthread/alsa via this header.
...
// ACVoice and SampleVoice now live in synth_types.h (shared with macOS SDL3 driver).
