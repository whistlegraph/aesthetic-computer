...
export function validateHeader(value) {
  ...
  if(consent.sharing==='company') {id(consent.id);date(consent.acceptedAt);if(![1,2].includes(consent.disclosureVersion))throw new Error('Consent disclosure required');}
