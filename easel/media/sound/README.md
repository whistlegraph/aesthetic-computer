...
Keep note times on beats or simple subdivisions and loops a whole number of beats.
The retired Electron sound deck is no longer included; native Sound support is
tracked in `apple/aesel/ROADMAP.md`.
