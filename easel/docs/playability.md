...
| Native `PromptPreview` capture bridge | Already identify the preview guest and verify channel/revision. File polling is currently 250 ms in the native overlay; this is a useful compatibility path, not the final fast loop. |
