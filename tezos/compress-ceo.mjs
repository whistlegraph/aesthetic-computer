...
const html = readFileSync('keep-bundles/ceo-minimal-nft.html', 'utf8');
...
<head>
  <meta charset="utf-8">
  <title>$ceo • Aesthetic Computer</title>
  <style>
...
writeFileSync('keep-bundles/ceo-self-contained.html', selfContained);
console.log('\n📝 Written to: keep-bundles/ceo-self-contained.html');
