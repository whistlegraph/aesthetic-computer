"""
KidLisp Keeps FA2 v9 - Aesthetic Computer NFT Contract (AUTHOR-PERMITTED KEEP)

This contract is the v9 final production release with signed keep author permits.
...
def keeps_module():
    ...
    class KidLispKeepsFA2v9(
        main.Admin,
        main.Nft,
        main.OnchainviewBalanceOf,
    ):
        """
        FA2 NFT contract for KidLisp Keeps (v9 - FINAL SIGNED-PERMIT PRODUCTION).
        ...
        def __init__(self, admin_address, contract_metadata, ledger, token_metadata):
            ...
            # v5/v6/v7/v8/v9: Default fee set to 2.5 XTZ for revenue activation
...
@sp.add_test()
def test():
    """Minimal test to compile v9 contract."""
    scenario = sp.test_scenario("KeepsFA2v9")
    scenario.h1("KidLisp Keeps FA2 v9 - Final Signed Permit Production Contract")
    ...
    # Deploy contract
    contract = keeps_module.KidLispKeepsFA2v9(
        admin.address,
        sp.big_map(),
        ledger,
        token_metadata
