...
<!-- stats:start -->
355 built-in pieces (337 JS + 18 KidLisp), ~79 API endpoints.<br>
2809 registered handles, 265 user-published pieces, 4416 paintings, 16364 KidLisp programs, 18032 chat messages, 20 prints ordered.<br>
*Last refreshed: Mar 8, 2026*
<!-- stats:end -->
