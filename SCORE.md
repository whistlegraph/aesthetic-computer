...
<!-- stats:start -->
355 built-in pieces (337 JS + 18 KidLisp), ~80 API endpoints.<br>
2810 registered handles, 265 user-published pieces, 4425 paintings, 16407 KidLisp programs, 18048 chat messages, 20 prints ordered.<br>
