...
| [AE-2026-002](AE-2026-002-resilience-institute/AE-2026-002.pdf) | 2026-05-21 | The Resilience Institute — Resilient Minds (Rebecca Bonneville, NP), c/o Fía Benitez | Four-area web app built as code — homepage + four pillars (psychiatry practice, mentoring & arts, classes, shop), Wix migration, two revision rounds, brand & design (logo + style guide); optional meeting-pack support priced separately | $8,900.00 | Draft |
| [AE-2026-003](AE-2026-003-regarde-consent-v0/AE-2026-003.pdf) | 2026-06-06 | Regarde (Jayson Mittman) | v0 of the subject-side consent mechanism — dispatch router (PDP, four operation classes), hash-chained verifiable receipt (JCS/RFC 8785 canonicalization, verify-offline), security & infrastructure hardening (private isolated hosting, private use), walkthrough app, proof-of-concept workflows; work-for-hire, runs on client stack, NDA-first; optional Aesthetic.Computer managed secure hosting + domain $500 (→ $3,250 all in) | $2,750.00 | Draft |
| [AE-2026-004](AE-2026-004-artur-calisthenics-consulting/AE-2026-004.pdf) | 2026-07-13 | Polygon Island LLC (Artur Matveichenkov; Guaynabo, PR) | Consulting meetings on the Calisthenics Puerto Rico app — architecture, deployment, payments/auth review, and next-step planning; advisory time only, no code deliverable (build work is a separate quote). Issued as a **paid receipt** ($200 cash) | $200.00 | Paid |
| [AE-2026-005](AE-2026-005-artur-calisthenics-advisory-pack-2/AE-2026-005.pdf) | 2026-07-16 | Polygon Island LLC (Artur Matveichenkov; Guaynabo, PR) | Four one-hour advisory meetings from July 24 through August 25 for the Calisthenics Puerto Rico app — architecture, deployment, LLM setup, payments/auth review, and next-step planning; advisory time only | $200.00 | Issued |
