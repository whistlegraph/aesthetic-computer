...
struct Api {
  ...
  // Read-only receipt for the most recent host-routed client error. The host
  // reports queued/posting/retrying/posted without exposing a network client.
  std::function<std::string()> client_error_report_status = {};
