% Generated KidLisp score card for $duv
...
\begin{tikzpicture}
  ...
  \node[anchor=south west, inner sep=0pt] at (0,0)
    {\includegraphics[width=\safewidth, height=\safewidth]{duv-screenshot.png}};
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=south east, inner sep=0pt]
    ...
    {\colorbox{black}{%
      \rule[-1pt]{0pt}{6.5pt}%
      \kern-1pt{\cardlabelfont\bfseries\fontsize{8pt}{8pt}\selectfont\color{white}\$duv}\kern-0.5pt%
    }};
  ...
  \node[anchor=south east, inner sep=1pt, fill=white]
    ...
    {\includegraphics[width=0.48in]{qr-duv.png}};
\end{tikzpicture}
