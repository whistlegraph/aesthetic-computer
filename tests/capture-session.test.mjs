...
test("compact camera capture scales logical pixels to an even device-sized frame", () => {
  assert.deepEqual(getCompactVideoSize(203, 395, 3), {
    width: 610,
    height: 1186,
  });
  assert.deepEqual(getCompactVideoSize(1080, 1920, 3), {
    width: 810,
    height: 1440,
  });
});
