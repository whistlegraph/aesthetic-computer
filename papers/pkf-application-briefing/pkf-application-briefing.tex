...
\vspace{0.7em}
{\large\itshape\color{acgray}Career evidence, picture-making history, and the road to ten eligible works}\par
\vspace{1.1em}
...
\begin{quote}
\large
The career is real, and 3,996 recovered drawings now make its picture-making history visible. The unresolved question is narrower: can we document ten qualifying exhibitions and ten recent physical works precisely enough to make a truthful Pollock-Krasner application?
\end{quote}
\vfill
\begin{center}
...
A newly recovered index of Jeffrey's \texttt{drawings.rey.sc} archive adds unusually concrete evidence to that arc: 3,996 drawings completed from September 2006 through August 2016, organized across 102 named working groups, 24 locations, and 19 collaborator records. It shows sustained picture-making rather than a selective retrospective. Its strategic role is history, not portfolio: almost all of the archive is outside PKF's ten-year image window, and its records do not consistently provide the physical-object metadata required for submission.
...
\item The complete \texttt{drawings.rey.sc} chronology was indexed, counted, visually sampled, and connected to Jeffrey's platter as an eleven-year picture-making history.
\end{itemize}
...
\subsection{A practice measured in pictures}

The archive begins while Jeffrey was still in high school and continues through Ringling, Yale, Brooklyn, and Los Angeles. Its 3,996 records include sketchbook pages, portraits, figures, flowers, diagrams, digital experiments, collaborations, and named working groups. This is the clearest evidence now in hand that drawing was not an occasional prelude to software: it was the daily substrate from which the later tools, scores, prints, and paintings grew.
...
\clearpage
\section{An eleven-year picture-making record}

Jeffrey built the public Ruby on Rails catalog in 2015 as \emph{a living archive of images}. The platter recovery preserves the archive's own chronological headings rather than mistaking derivative-image upload dates for completion dates. The result is a verifiable completion history from September 2006 through August 2016.

\begin{center}
\small
\begin{tabular}{rr@{\qquad}rr@{\qquad}rr}
\toprule
Year & Drawings & Year & Drawings & Year & Drawings \\
\midrule
2006 & 107 & 2010 & 754 & 2014 & 367 \\
2007 & 255 & 2011 & 446 & 2015 & 355 \\
2008 & 332 & 2012 & 38  & 2016 & 359 \\
2009 & 911 & 2013 & 72  & Total & \textbf{3,996} \\
\bottomrule
\end{tabular}
\normalsize
\end{center}

The count matters because it makes duration visible. The pictures do not resolve into one signature style: figures become creatures; flowers become diagrams; notebook studies become blackboard fields; writing, arrows, and instructions enter the surface. Across eleven years, the archive repeatedly treats a picture as both an image and a score for what might happen next.

\begin{quote}
\textbf{Grant use.} Put one sentence of this scale in the cover letter. Use the archive internally to identify recurring forms and locate later objects. Do not submit it as the ten-image portfolio: old drawings are outside the window, and even the 2016 boundary records need medium, dimensions, ownership, and current photography.
\end{quote}

\clearpage
\section{Eleven years in pictures}

\begin{center}
\includegraphics[height=0.76\textheight,keepaspectratio]{../../grants/pollock-krasner-2026/visual-research/drawings-lineage.jpg}
\end{center}

\small One dated work from each completion year, selected to show continuity rather than to propose a portfolio. Source: \href{https://drawings-rey-sc.jas.life}{drawings.rey.sc}; recovered index: Jeffrey's drawings platter.\normalsize
...
The drawings archive is a discovery tool for this inventory, not a shortcut around it. Search its titles, years, and visual motifs to locate objects and establish formal continuity; only move a work into the application table after all eight fields above are verified and the work falls inside PKF's current date window.
...
That continuity is documented in an archive of 3,996 drawings I completed between 2006 and 2016. It is not the portfolio I am submitting; it is the working history behind these ten recent pictures.
...
\item \textit{Unidentified platter physical painting A}, [year], [medium], [dimensions].
\item \textit{Unidentified platter physical painting B}, [year], [medium], [dimensions].
\end{enumerate}
...
\item[\todo] Use the recovered drawings platter to trace motifs and locate post-2016 object leads.
...
\small
\textbf{Grant package:} \texttt{grants/pollock-krasner-2026/}\\
\textbf{Briefing source:} \texttt{papers/pkf-application-briefing/}\\
\textbf{Canonical CV:} \texttt{papers/cv/cv.tex}\\
\textbf{Picture archive:} Jeffrey's drawings platter and generated \texttt{manifest.json}
\normalsize

\colophon{Prepared from the Aesthetic Computer monorepo, the papers and platter stacks, the recovered \texttt{drawings.rey.sc} archive, prior submitted applications, and git history. This briefing distinguishes repository evidence from claims that still need external documentation.}
