...
% First print edition — drop the WORKING DRAFT watermark.
\acdraftfalse
...
\vspace*{0.3em}
\begin{center}
\href{https://papers.aesthetic.computer}{\includegraphics[width=0.74\textwidth]{figures/cover}}\par
\vspace{0.45em}
...
\vspace{0.2em}
{\small\sffamily\klanghere{EN}\klangsep\klang{DA}{-da}\klangsep\klang{ES}{-es}\klangsep\klang{ZH}{-zh}\klangsep\klang{JA}{-ja}\klangsep\klang{RU}{-ru}}\par
\vspace{0.2em}
{\scriptsize\color{acgray} March 2026 \,\textperiodcentered\, \href{https://github.com/whistlegraph/aesthetic-computer/commit/462fcf0c0}{462fcf0c0}}\par
\end{center}
...
% === COLOPHON: edition badge + revision/QR badge + changelog ===
% Cards are single-column at \textwidth (~3.2in / 8.1cm); the badges are
% ~7.7cm wide and centered. (The two-column arxiv edition uses a
% half-column variant — do not copy these widths back to keymaps.tex.)
\definecolor{acgold}{HTML}{C9A227}
\newpage
\noindent\begin{minipage}{\textwidth}
\centering
\begin{tikzpicture}
\useasboundingbox (-3.9,-5.05) rectangle (3.9,3.05);
% ---------- PINK badge: FIRST PRINT EDITION (top, compact) ----------
\begin{scope}[shift={(0,1.7)}]
 \fill[acpink!4, rounded corners=7pt] (-3.85,-1.25) rectangle (3.85,1.25);
 \draw[acpink!60, line width=1.0pt, rounded corners=7pt] (-3.85,-1.25) rectangle (3.85,1.25);
 \draw[acpink!32, line width=0.4pt, rounded corners=5.5pt] (-3.7,-1.1) rectangle (3.7,1.1);
 \node at (0, 0.80) {\small\sffamily\bfseries\color{acpink} FIRST PRINT EDITION};
 \draw[acpink!32, line width=0.4pt] (-3.4,0.50) -- (3.4,0.50);
 \node at (0, 0.08) {\footnotesize\color{acgray} Published for \emph{Scores for Social Software}};
 \node at (0, -0.55) {\footnotesize\color{acgray} June 2026 \,\textperiodcentered\, UCLA Design\,\textbar\,Media Arts};
\end{scope}
% ---------- YELLOW badge: revision + QR (bottom) ----------
\begin{scope}[shift={(0,-2.35)}]
 \fill[acgold!8, rounded corners=7pt] (-3.85,-2.6) rectangle (3.85,2.6);
 \draw[acgold!75, line width=1.0pt, rounded corners=7pt] (-3.85,-2.6) rectangle (3.85,2.6);
 \draw[acgold!42, line width=0.4pt, rounded corners=5.5pt] (-3.7,-2.45) rectangle (3.7,2.45);
 \node at (0, 2.18) {\small\sffamily\bfseries\color{acgold!80!black} REVISION \paperrev};
 \draw[acgold!42, line width=0.4pt] (-3.4,1.88) -- (3.4,1.88);
 \node at (0, 0.18) {\includegraphics[width=2.7cm]{figures/qr/canonical.png}};
 \node at (0, -1.55) {\footnotesize\ttfamily\color{acgray} \paperhash};
 \node at (0, -2.20) {\scriptsize\ttfamily\color{acgray} papers.aesthetic.computer/keymaps-social-software-26-arxiv};
\end{scope}
\end{tikzpicture}
\par\vspace{10pt}
{\footnotesize\raggedright\setlength{\parindent}{0pt}%
{\sffamily\bfseries\color{acgold!80!black} Revision history}\par
\vspace{0.3em}\hrule height0.4pt\vspace{0.4em}
\paperhistory\par}
\end{minipage}
