...
\vspace*{\fill}
\begin{center}
\includegraphics[width=0.62\linewidth]{figures/cover}\par
\vspace{0.5em}
{\acbold\fontsize{18pt}{22pt}\selectfont\color{acdark} Keymaps as Social Software}\par
\vspace{0.1em}
{\fontsize{9pt}{11pt}\selectfont\color{acpink} Versioned Virtual Objects via Social Contract}\par
\vspace{0.4em}
...
\vspace{0.1em}
{\footnotesize\color{acgray} March 2026 · \href{https://github.com/whistlegraph/aesthetic-computer/commit/b53eca237}{b53eca237}}\par
\end{center}
\vspace*{\fill}
...
\begin{tabular}{@{}>{\RaggedRight}p{0.18\textwidth}>{\RaggedRight}p{0.21\textwidth}>{\RaggedRight}p{0.13\textwidth}>{\RaggedRight\arraybackslash}X@{}}
\toprule
