...
% Trumpet (top-left) — bare silhouette, no overlaid labels
\node[anchor=south west, inner sep=0pt] at (0, 1.40)
  {\includegraphics[width=2.4cm]{trumpet.png}};
% Ocarina (top-right) — bare silhouette
\node[anchor=south west, inner sep=0pt] at (4.45, 1.40)
  {\includegraphics[width=1.0cm]{ocarina.png}};
% Guitar tuning (bottom-left): 6 strings, M3 break highlighted
\begin{scope}[shift={(0, 0)}]
  \foreach \i/\note/\hl in {1/E/0, 2/A/0, 3/D/0, 4/G/0, 5/B/1, 6/E/0} {
    \draw[string] (0, {0.60 - (\i-1)*0.12}) -- (1.85, {0.60 - (\i-1)*0.12});
    \ifnum\hl=1
      \node[font=\tiny\sffamily\bfseries, text=keymapped!90, anchor=east]
        at (-0.04, {0.60 - (\i-1)*0.12}) {\note};
    \else
