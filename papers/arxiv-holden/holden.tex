...
\twocolumn[{%
\begin{center}
{\acbold\fontsize{20pt}{24pt}\selectfont\color{acdark} The Potter and the Prompt}\par
\includegraphics[width=0.5\textwidth]{figures/cover}\par
\vspace{0.35em}
\vspace{0.2em}
{\aclight\fontsize{11pt}{13pt}\selectfont\color{acpink} John Holden's Proto-Cognitive Music Theory\\ and Aesthetic Computer}\par
\vspace{0.6em}
