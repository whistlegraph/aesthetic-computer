...
Open almost any music app and you can already play your keyboard like a piano: A is C, W is C-sharp, S is D, on up a staircase of letters that have nothing to do with the notes they make. Nobody owns it. No company invented it and no patent covers it --- every program has it because every other program has it. It's social software in its purest form. And it's terrible. It eats both hands to cover a single octave, and you can't figure it out without a tutorial. Nobody chose it. It just piled up.
...
And as a parting gift: a simpler version of that keymap is sitting just below, written in p5.js, so you can play it yourself.
