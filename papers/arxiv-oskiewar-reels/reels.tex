...
\code{xbox/live/oskiewar.js} (6,404 lines) and \code{xbox/live/mac-test.html}
...
factory. \code{oskiewar.js} calls \code{Math.random} exactly once, at line 611, to
...
Stage two runs \code{mac-test.html} and \code{oskiewar.js} in headless Chrome
...
\code{oskiewar.js} declares \code{matchWins = 5} and the result screen prints it,
