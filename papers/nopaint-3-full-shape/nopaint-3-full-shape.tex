...
\textbf{The center stays human.} A machine proposes. A person perceives. \textbf{No} discards; \textbf{Paint / Yes / Yay} preserves. Basic brushes, KidLisp growth, visual inference, Merry sequencing, remote search, handles, uploads, tutorials, and archives supply, judge, remember, or continue that encounter. No Paint 3.0 treats that decision as a durable system boundary rather than merely a pair of buttons.
