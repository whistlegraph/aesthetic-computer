% !TEX program = xelatex
% "What's New CalArts!?" — a dossier (canonical arXiv source).
% Deliverable is the cards build (calarts-news-cards.tex); this source
% exists for the platter and a future arXiv build, kept in parity.
...
\AddToShipoutPictureBG{%
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[opacity=0.10, rotate=45, anchor=center]
      at (current page.center)
      {{\aclight\fontsize{2.4cm}{3cm}\selectfont\color{acpink} DOSSIER}};
  \end{tikzpicture}%
}
...
\fancyhead[C]{\footnotesize\color{acpink}\textit{dossier --- working draft --- not for citation}}
...
{\acbold\fontsize{22pt}{26pt}\selectfont\color{acdark} What's New CalArts!?}\par
\vspace{0.2em}
{\aclight\fontsize{11pt}{13pt}\selectfont\color{acpink} why the president got booed off the stage --- a letter, with sources}\par
\vspace{0.6em}
...
\begin{center}
{\small\color{acpink}\textbf{[ dossier --- working draft --- not for citation ]}}
\end{center}
\vspace{0.3em}
