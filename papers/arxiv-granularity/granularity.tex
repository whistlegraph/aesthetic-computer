...
% Do not vertically justify columns to the bottom --- otherwise short
% paragraphs (the platform entries in \S3) get their inter-paragraph glue
% stretched, which reads as excessive space above the bold leads.
\raggedbottom
