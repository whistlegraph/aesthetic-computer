...
**Maximal evenness and Euclidean rhythms (Clough & Douthett; Toussaint).** Clough and Douthett ("Maximally Even Sets," *Journal of Music Theory*, 1991) formalised the idea of distributing $k$ onsets among $n$ pulses as evenly as the integer grid allows. Toussaint ("The Euclidean Algorithm Generates Traditional Musical Rhythms," 2005; and *The Geometry of Musical Rhythm*, 2013) showed that these maximally even sets are exactly the patterns produced by applying Euclid's GCD algorithm to $(k, n)$, and that an astonishing number of world timelines *are* Euclidean rhythms: the bembé bell is E(7,12); the maximally even five-in-sixteen pattern E(5,16) is the bossa-nova necklace. (An earlier revision of this thesis called E(5,16) "the canonical 2-3 son rotation." That was wrong, and the error mattered here of all places, since this track treats son, rumba, and E(5,16) as three *distinct* timelines. Son has inter-onset intervals (3,3,4,2,4); a maximally even five-in-sixteen is (3,3,3,3,4), so son is not maximally even and not a Euclidean rhythm. Toussaint 2005 §4 states that E(5,16) "is also the Bossa-Nova rhythm necklace of Brazil." See [`papers/rhythm-platter`](../../../papers/rhythm-platter/).) Geometrically, evenness is captured by inscribing the onsets as vertices on a regular $n$-gon and summing the chord lengths between every pair of onsets; the regular $k$-gon — the perfectly even set — provably maximises this sum.
