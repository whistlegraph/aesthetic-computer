#!/usr/bin/env python3
"""xpld-clickvox — the vocalized click track study.
...
Writes out/xpld-clickvox.wav (+ .mp3 via ffmpeg) and
...
wav = os.path.join(OUT, "xpld-clickvox.wav")
sf.write(wav, mix, SR)
subprocess.run(["ffmpeg", "-y", "-loglevel", "error", "-i", wav,
                "-b:a", "192k", os.path.join(OUT, "xpld-clickvox.mp3")], check=True)
