...
const SECTION_TINTS = {
  intro:  "rgba(110,130,160,1)",  // dusk grey-blue — fog on the harbour
  break1: "rgba(160,180,200,1)",  // silver mist — the sea is a screen
  build1: "rgba(130,150,180,1)",  // deeper twilight — ride the slow horse
  drop1:  "rgba(80,120,160,1)",   // navy blue — the long blue hum
  break2: "rgba(170,180,190,1)",  // misty silver — drift
  build2: "rgba(110,130,150,1)",  // storm grey — hold
  drop2:  "rgba(180,210,200,1)",  // glowing tide — glow in the grey tide
  outro:  "rgba(232,196,140,1)",  // warm dawn amber — home
};
