...
void draw() {
  ...
  const docs = {
    ...
    prompts: {
      ...
      cut: {
        sig: "cut",
        desc: "Stop the active tape recording and finalize the clip.",
        examples: ["cut", "tape:cut"],
        returns: "void",
        done: true,
      },
      me: {
      ...
      print: {
        sig: "print",
        desc: "Open the print flow for the current painting.",
        examples: ["print"],
        returns: "void",
        done: true,
      },
      mint: {
        sig: "mint",
        desc: "Open mint flow for the current painting.",
        examples: ["mint"],
        returns: "void",
        done: true,
      ...
      "yes!": {
        ...
        sig: "done",
        desc: "Finish and confirm your painting.",
        examples: ["done"],
        returns: "void",
        done: true,
      },
      ...
      upload: {
        sig: "upload",
        desc: "Upload your current painting/media.",
        examples: ["upload"],
        returns: "void",
        done: true,
      },
      ...
      signup: {
        sig: "signup",
        desc: "Sign up.",
        examples: ["signup", "imnew"],
        returns: "void",
        done: true,
      },
      imnew: {
        sig: "imnew",
        desc: "Alias for sign up.",
        examples: ["imnew"],
        returns: "void",
        done: true,
      },
