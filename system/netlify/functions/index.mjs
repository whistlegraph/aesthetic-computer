      ...
      <body class="native-cursor" ${lanHost ? " data-lan-host=" + lanHost : ""}>
        ...
        <script>
          ...
          function anim(){if(!run||!c)return;f++;lb*=0.94;var chaos=0.3+bp*0.4+lb*0.3;var t=f*0.05;
            ...
            var sHH=HH*S;
            var NAMECOLS=['#ff6b6b','#6bff8b','#6b8bff','#ffcf6b','#cf6bff','#6bffff','#ff6bcf','#8bff6b'];
            var HDRCOLS=['#3d2828','#283d2c','#28283d','#3d3428','#34283d','#283d3d','#3d2834','#2c3d28'];
            ...
            for(var i=0;i<pages.length;i++){var p=pages[i];var jx=(Math.random()-0.5)*S,jy=(Math.random()-0.5)*0.7*S;
              ...
              var pHdrCols=['#3d2828','#283d2c','#28283d','#3d3428','#34283d','#283d3d','#3d2834','#2c3d28'];x.fillStyle=pHdrCols[p.hdrIdx%pHdrCols.length];x.fillRect(0,0,p.w,6*S);
