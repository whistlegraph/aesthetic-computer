...
const ZZZWAP_KIDLISP_SOURCES = {
  ...
  BUFFERING: `(fade:orange-yellow-orange) (ink orange (+ 80 (* amp 120))) (ink orange (+ 30 (* (random) 80))) (flood (/ width 2) (/ height 2)) (ink orange 200) (circle (/ width 2) (/ height 2) (+ 8 (* amp 15))) (box (- (/ width 2) 10) (- (/ height 2) 10) 20 20) (spin (0.8s... -3.0 3.0)) (zoom (2s... 1.0 1.5)) (contrast 1.4) (ink orange (+ 120 (* amp 100))) (repeat 128 point) (scroll (? 0 0 2 -2) (? 0 0 2 -2))`
};
