// F3ral3xp, 2025.5.11.16.42.18.348
// Experiments for Feral File.

/* 📝 Notes
  TODO:
  - [🦜] Get this piece intergated into the FF codebase.
 */
...
function paint({ api, wipe, ink, line, screen, box, circle, pen, write }) {
  ...
  if (pen) {
    ...
    ink("white").write("Hello Feral File!", { x: pen.x, y: pen.y + 12, center: "x" });
  }
}
