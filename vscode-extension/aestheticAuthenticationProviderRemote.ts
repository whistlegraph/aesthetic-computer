...
export class AestheticAuthenticationProvider implements AuthenticationProvider, Disposable {
   ...
   * @returns 
   */
  public async getSessions(scopes?: string[]): Promise<readonly AestheticAuthenticationSession[]> {
    try {
   ...
   * @returns 
   */
  public async createSession(scopes: string[]): Promise<AestheticAuthenticationSession> {
    try {
