  ...
  return `<!DOCTYPE html>
        ...
        <style>
          iframe#aesthetic {
			...
			<body>
        <iframe id="aesthetic" credentialless sandbox="allow-scripts allow-same-origin allow-modals allow-popups allow-popups-to-escape-sandbox allow-pointer-lock" allow="clipboard-write; clipboard-read; pointer-lock" src="${iframeProtocol}${iframeUrl}/${param}${hashFragment}" border="none"></iframe>
