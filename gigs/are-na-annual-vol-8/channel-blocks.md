...
- [aesthetic.computer (@whistlegraph) on TikTok](https://www.tiktok.com/@whistlegraph)
  > 2.6 million followers. The distribution channel of a form that teaches itself.
- [Whistlegraph · Aesthetic Computer](https://aesthetic.computer/whistlegraph)
  > The practice site: draw while singing, the result IS the score. Record, learn, perform.
- [Explore Whistlegraph's art and journey on Feral File](https://feralfile.com/artists/whistlegraph)
...
- **Text:** *Every mark is a sung syllable. Watching, learning, and performing collapse into a single gesture.*

## §9 — Framing text

- **Text:** *A drawing that constructs the performance it depicts.*
- **Text:** *The score teaches you how to play it.*
- **Text:** *Reproducibility, not algorithmic promotion, explains its viral spread.*

## §8 — Computational / card-sized kin

- [Prompt · Aesthetic Computer](https://aesthetic.computer/prompt)
...
- [Bitsy](https://en.wikipedia.org/wiki/Bitsy)
...
- [Inform 7](https://en.wikipedia.org/wiki/Inform_7)
  > Interactive fiction that reads like plain English. The source IS the play.

## §7 — 20th-century graphic scores (the canon)

- [Notations (Cage, 1969)](https://www.moma.org/s/ge/curated_ge/styles/list_ge/artists/1191/)
  > John Cage's 1969 anthology — the graphic-score genre's first self-portrait.
- [Notations 21](https://en.wikipedia.org/wiki/Notations_21)
  > Theresa Sauer's 2009 follow-up — the tradition's next generation.
- [Treatise (Cardew)](https://en.wikipedia.org/wiki/Treatise_(Cardew))
  > Cardew's 193-page graphic score — no instructions, no interpretation guide. The reader is the score.
- [Fontana Mix](https://en.wikipedia.org/wiki/Fontana_Mix)
  > Cage's transparent overlay system — the first reconfigurable score.
- [Aria (Cage)](https://en.wikipedia.org/wiki/Aria_(Cage))
  > Colored curves for vocal register, shapes for technique. A score you read like a weather map.
- [Concert for Piano and Orchestra (Cage)](https://en.wikipedia.org/wiki/Concert_for_Piano_and_Orchestra_(Cage))
  > Eighty-four score 'solos' to be played in any order, for any duration, in any combination.
- [Variations I (Cage)](https://en.wikipedia.org/wiki/Variations_I)
  > Transparent sheets, dots and lines — the score is a configuration, not a sequence.
- [December 1952 (Earle Brown)](https://en.wikipedia.org/wiki/December_1952)
  > Earle Brown's single page — rectangles in two dimensions, read in any direction.
- [Morton Feldman](https://en.wikipedia.org/wiki/Morton_Feldman)
  > Feldman's graph pieces — intensity and register on a grid. Pitch becomes a choice, not an instruction.
- [Christian Wolff](https://en.wikipedia.org/wiki/Christian_Wolff_(composer))
...
- [Metastaseis (Xenakis)](https://en.wikipedia.org/wiki/Metastaseis)
  > Xenakis drafted string glissandi like architectural sections. The score is geometry.
- [Sonic Meditations (Oliveros)](https://en.wikipedia.org/wiki/Sonic_Meditations)
  > Pauline Oliveros's text scores for group listening — attention itself as the performance.
- [I Am Sitting in a Room (Lucier)](https://en.wikipedia.org/wiki/I_Am_Sitting_in_a_Room)
  > Lucier's one paragraph of text — an entire composition.
- [In C (Terry Riley)](https://en.wikipedia.org/wiki/In_C)
  > Terry Riley: 53 phrases on one page, any ensemble, 45–90 minutes. A score infinitely rehearsable.
- [Composition 1960 (La Monte Young)](https://en.wikipedia.org/wiki/Composition_1960)
...
- [Water Yam (Brecht)](https://en.wikipedia.org/wiki/Water_Yam)
  > George Brecht's event cards — single-instruction scores the size of a business card.
- [Dick Higgins](https://en.wikipedia.org/wiki/Dick_Higgins)
  > Danger Music and the idea of scores that can't be performed safely.
- [An Anthology of Chance Operations](https://en.wikipedia.org/wiki/An_Anthology_of_Chance_Operations)
  > La Monte Young's 1963 anthology — the origin point of Fluxus event scores.
- [Alison Knowles](https://en.wikipedia.org/wiki/Alison_Knowles)
  > Make A Salad (1962): the salad is the score. The performance is eating.
- **Text:** *"Draw a line. Follow it." — Yoko Ono, *Line Piece* (1964).*

## §5 — Vernacular / folk notation

- [Shape note](https://en.wikipedia.org/wiki/Shape_note)
...
- [Eshkol–Wachman Movement Notation](https://en.wikipedia.org/wiki/Eshkol%E2%80%93Wachman_Movement_Notation)
  > Noa Eshkol's system: the body as angles and arcs, notated on a grid.
- [Benesh Movement Notation](https://en.wikipedia.org/wiki/Benesh_Movement_Notation)
...
- [American football plays](https://en.wikipedia.org/wiki/American_football_plays)
  > X's and O's that collapse into eleven bodies moving in time.

## §2 — Instructional / craft

- [Knitting abbreviations](https://en.wikipedia.org/wiki/Knitting_abbreviations)
...
- [Sewing pattern](https://en.wikipedia.org/wiki/Sewing_pattern)
...
- [Renegade (dance)](https://en.wikipedia.org/wiki/Renegade_(dance))
...
- [Harlem Shake (meme)](https://en.wikipedia.org/wiki/Harlem_Shake_(meme))
...
- [How to draw Squidward](https://knowyourmeme.com/memes/how-to-draw-squidward)
