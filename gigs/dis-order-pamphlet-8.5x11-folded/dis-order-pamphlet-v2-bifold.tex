...
\newcommand{\panelblock}[3]{%
  \begin{textblock*}{#1}(#2,#3)
    \begin{minipage}[t][8.14in][t]{#1}
      \raggedright
}

\newcommand{\panelblockend}{%
    \end{minipage}
  \end{textblock*}
}
...
\newcommand{\foldline}{%
  \begin{textblock*}{0.01in}(5.5in,0in)
    {\color{gray!65}\rule{0.5pt}{8.5in}}
  \end{textblock*}
}

\newcommand{\riteline}[3]{%
  \begin{minipage}[t]{0.31\linewidth}
    \includegraphics[width=\linewidth,height=0.84in,keepaspectratio]{#3}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.66\linewidth}
    {\fontsize{8.6}{9.3}\selectfont\textbf{#1}\\#2}
...
\panelblock{5.2in}{0.16in}{0.18in}
{\fontsize{5.0}{5.45}\selectfont
\textbf{Dis-Order}\\
\textit{Back panel}\par
\vspace{0.05in}
\textbf{Bios (continued)}
...
\panelblock{5.2in}{5.64in}{0.18in}
\begin{center}
  \includegraphics[width=\linewidth,height=3.0in,keepaspectratio]{images-v2/cover.jpg}\\[0.24in]
  {\fontsize{38}{42}\selectfont\textbf{Dis-Order}}\\[0.5em]
  {\fontsize{15}{17}\selectfont welcome,}\\[0.3em]
  {\fontsize{15}{17}\selectfont we've been waiting for you}
\end{center}

\vfill
{\fontsize{7.1}{8.0}\selectfont Single-sheet half-fold: print double-sided, flip on short edge, then fold in half.}
\panelblockend
...
\textbf{Left Inside Flap}\\[-0.2em]
\textit{Ritual sequence}
}

\riteline{I.}{begin with fire}{images-v2/i-candles.jpg}
\riteline{II.}{wicked child bacchanal}{images-v2/ii-donkey.jpg}
\riteline{III.}{total darkness}{images-v2/iii-egg.jpg}
\riteline{IV.}{lovers' pastoral}{images-v2/iv-pastoral.jpg}
\riteline{V.}{death of the first born}{images-v2/v-daughter.jpg}

\vfill
{\fontsize{6.4}{7.2}\selectfont Images selected from Ari reference set and mapped to the I--V sequence notes.}
\panelblockend
...
\textit{Bios continue on the back panel.}
}
\panelblockend
