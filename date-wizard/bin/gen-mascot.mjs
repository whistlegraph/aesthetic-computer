#!/usr/bin/env node
// date-wizard/bin/gen-mascot.mjs — generate the DateWizard app mascot.
//
// Prompt: date-wizard/Sources/DateWizard/Assets/datewizard-mascot-prompt.txt
// Output: date-wizard/Sources/DateWizard/Assets/datewizard-mascot.png
//
// Usage:
//   node date-wizard/bin/gen-mascot.mjs           # cached if mascot exists
//   node date-wizard/bin/gen-mascot.mjs --force   # regenerate
...
const PROMPT_PATH = `${LANE}/Sources/DateWizard/Assets/datewizard-mascot-prompt.txt`;
const OUT_PATH    = `${LANE}/Sources/DateWizard/Assets/datewizard-mascot.png`;
...
console.log(`▸ date-wizard mascot · ${SIZE}`);
const t0 = Date.now();
