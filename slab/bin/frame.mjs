...
if (!cmd || cmd === "-h" || cmd === "--help") {
  console.log(
    "frame — capture the focused window (pixels + OCR + AX + state) of a remote Mac\n\n" +
      "  frame <machine> [--screen] [--no-ocr] [--no-visual] [--fast] [--cursor] [--target-at x,y] [--target-id id] [--manual-check id] [--press-at x,y] [--action-only] [--clear-target] [--clear-overlays] [--quiet-overlay] [--overlays] [--direct] [--preview] [--out file.jpg] [--json]\n" +
