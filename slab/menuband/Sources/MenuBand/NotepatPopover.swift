...
final class NotepatPopoverViewController: NSViewController {
    weak var notepat: NotepatController?
    ...
    override func loadView() {
        ...
        keymapSegmented = NSSegmentedControl(labels: ["Notepat", "Ableton"],
    ...
    func syncFromController() {
        guard isViewLoaded, let n = notepat else { return }
