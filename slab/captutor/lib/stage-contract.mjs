...
export function assertHiDPIStage({
  ...
  if(nativeDisplay){
    if(Number(screen.width)!==nativeDisplay.width||Number(screen.height)!==nativeDisplay.height)throw new StageContractError("Native display geometry changed during preparation",{screen,nativeDisplay});
    return {...screen,mode:"native"};
  }
