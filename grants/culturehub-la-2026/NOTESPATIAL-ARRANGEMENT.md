...
| III | **Waltz** | 1:56 | 1:18 | A minor, 3/4, 132 easing to 112 | Oom at the back (seat 4), pah left (seat 2), pah right (seat 5). Taps mark all three beats. A tune in the hands, twice. Then the ring hops the tune around the room while the hands hold a counterline. The tune again with the ring a third below. A tag that eases; every laptop lands on A. | A sway; then melody circling under a held line |
...
| VII | **The Climb** | 6:15 | 1:05 | C, 4/4, 112 to 124 | Four registers an octave apart, one phrase each. A high line glides counter-clockwise against the walk. Hats in the last phrase. The last bar: a rising D-major lap into a beat and a half of percussion alone. | Two directions, then percussion alone |
...
The mallets-and-kick score has 17,018 events and peaks at 28 simultaneous
