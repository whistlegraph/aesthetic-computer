...
\begin{tabularx}{\textwidth}{@{}lX@{}}
  ...
  \textbf{Fall 2028} & \textbf{2028 Demo Day ``We play the room.''} A multi-station AC Native installation premieres on the LACMA floor, and visitors and artists play together across the stations. v1.0 of the open-source build pipeline ships alongside, so any institution can run its own room. Public programs introduce the system to teachers, museum educators, and other artists. \\
\end{tabularx}
