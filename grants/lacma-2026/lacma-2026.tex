...
\begin{center}
  ...
  {\small\color{acgray} \textbf{Fig.\,3} --- Four KidLisp pieces as printable cards: \textit{\$berz}, \textit{\$24m}, \textit{\$duv}, and \textit{\$kl1}. Each card is a self-contained program---the pixel image at top is the live output; the code underneath is the complete source. Printed cards were produced for Casey Reas \& Laurent Bourgault's ``Social Software'' course at UCLA (2026). QR codes link back to the live piece on \ac.}
\end{center}
