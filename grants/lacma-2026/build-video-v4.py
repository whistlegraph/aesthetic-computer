...
CARDS = HERE / "video-cards-v4"
CARDS.mkdir(exist_ok=True)
OUT = HERE / "lacma-grant-video-v4.mp4"
DEMO = Path("/Users/jas/aesthetic-computer/system/public/assets/lacma-2026/ac-native-demo-narrated.mp4")
VO_HOOK = HERE / "vo-hook-pvc.wav"
VO_MAIN = HERE / "vo-main-pvc.wav"
ALIGN_HOOK = json.loads((HERE / "vo-hook-pvc.json").read_text())
ALIGN_MAIN = json.loads((HERE / "vo-main-pvc.json").read_text())
