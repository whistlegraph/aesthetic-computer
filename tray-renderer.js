...
class TrayRenderer {
  constructor(tray) {
    ...
    this.dirty = false;
    // Fully composited tray frames are deterministic for a given source frame
    // and state. Cache them so the main process does no SVG rasterization or
    // pixel compositing after the first rotation.
