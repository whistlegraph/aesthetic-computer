...
export const learnFuserBrandChrome = Object.freeze({
  ...
  leftMarkCenterY: 0.69,
  leftLabelCenterY: 0.785,
  rightMarkCenterY: 0.31,
  rightLabelCenterY: 0.215,
  labelStrokeFraction: 0,
  labelShadow: false,
  labelColor: "#4f3d59",
  sectionLabel: true,
  sectionLabelOpacity: 0.88,
  formats: {
