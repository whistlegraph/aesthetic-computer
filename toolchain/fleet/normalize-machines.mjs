...
const ENRICH = {
  ...
  blueberry: {
    designation: "control",
    capabilities: ["macos-automation", "screen-capture", "ffmpeg-render"],
...
const ADD = {
  neo: {
    ...
    designation: "control",
    capabilities: ["git-remote", "macos-automation", "screen-capture", "ffmpeg-render"],
    tailscale: { name: "neo", ip: "100.108.5.81" },
    status: { source: "tailscale", key: "neo" },
    fleetRole: "Primary control MacBook — holds GitHub auth and can absorb one fleet render only while its interactive guard has headroom.",
  ...
  chicken: {
    ...
    designation: "build",
    capabilities: ["build-macos", "chromium-pool", "macos-automation", "ffmpeg-render", "always-on"],
