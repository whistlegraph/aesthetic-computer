...
const io = geckos({
  ...
  cors: {
    ...
    origin: dev ? "*" : (req) => {
      const allowed = ["https://aesthetic.computer", "https://notepat.com", "https://kidlisp.com", "https://pj.kidlisp.com", "https://laklok.com", "https://www.laklok.com"];
...
wss.on("connection", async (ws, req) => {
  ...
  // Handle-scoped agent presence — lights the agent mark on AC surfaces.
  if (agentPresenceManager.handleConnection(ws, req)) return;
