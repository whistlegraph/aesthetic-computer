#!/usr/bin/env node
// wave-wizard/bin/gen-mascot.mjs — generate the WaveWizard app mascot.
//
// Prompt: wave-wizard/Sources/WaveWizard/Assets/wavewizard-mascot-prompt.txt
// Output: wave-wizard/Sources/WaveWizard/Assets/wavewizard-mascot.png
//
// Usage:
//   node wave-wizard/bin/gen-mascot.mjs           # cached if mascot exists
//   node wave-wizard/bin/gen-mascot.mjs --force   # regenerate
...
const PROMPT_PATH = `${LANE}/Sources/WaveWizard/Assets/wavewizard-mascot-prompt.txt`;
const OUT_PATH    = `${LANE}/Sources/WaveWizard/Assets/wavewizard-mascot.png`;
...
console.log(`▸ wave-wizard mascot · ${SIZE}`);
const t0 = Date.now();
